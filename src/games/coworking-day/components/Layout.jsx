...
export default function CoworkingLayout({ user }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-3 sm:gap-8">
          <NavLink to="/" className="shrink-0 flex items-center gap-2" title="Back to Hub">
            ...
            <span className="font-display font-semibold tracking-tight text-lg flex items-center gap-1.5">
              ...
              <span className="ml-2 text-[10px] tracking-[0.3em] uppercase text-arena-blue font-normal align-middle hidden sm:inline-block">
                {t("coworking.brand_tag")} 🏢
              </span>
            </span>
          </NavLink>
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            {isAdmin && (
              <NavLink
                to="/admin"
                className="inline-flex items-center gap-2 rounded-md bg-arena-blue/15 hover:bg-arena-blue/25 text-arena-blue border border-arena-blue/30 px-3 py-1.5 text-xs font-semibold tracking-wide uppercase"
              >
                Admin
              </NavLink>
            )}
